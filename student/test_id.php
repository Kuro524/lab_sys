  ...
  <body>
    ...
    <div class="container">
      <?php
        ...
        $name=mysqli_real_escape_string($link, $_POST["stu_name"]);

        $sql_code="SELECT student.id,student.name,student.name_ruby,course.name FROM student LEFT OUTER JOIN course ON student.s_course_cd = course.code WHERE student.id = '$id' AND student.name = '$name'";
